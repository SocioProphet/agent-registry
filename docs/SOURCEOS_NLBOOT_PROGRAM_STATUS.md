...
| `SourceOS-Linux/sourceos-devtools` | #6 | #7 | merged / closed | Copilot | complete for current slice. |
...
| `SocioProphet/homebrew-prophet` | #9 | #10 | merged / closed | Copilot | complete for current slice. |
